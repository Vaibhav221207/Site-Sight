...
window.Buildings = (function () {
  var BUILDINGS = [
    ...
    { id: "mine",       zone: "mining", label: "Mine",           role: "extractor",
      ...
      buildCost: 300, incomePerTick: 6,  pollutionPerTick: 1,
    ...
    { id: "quarry",     zone: "mining", label: "Quarry",       role: "extractor",
      ...
      buildCost: 500, incomePerTick: 8,  pollutionPerTick: 2,
    ...
    { id: "corner-shop", zone: "commercial", label: "Corner Shop", role: "earner", buildCost: 200, incomePerTick: 12, pollutionPerTick: 0 },
    { id: "market", zone: "commercial", label: "Market", role: "earner", buildCost: 350, incomePerTick: 20, pollutionPerTick: 0 },
    { id: "retail-center", zone: "commercial", label: "Retail Center", role: "earner", buildCost: 600, incomePerTick: 36, pollutionPerTick: 1 },
    { id: "industrial-plant", zone: "industrial", label: "Industrial Plant", role: "earner", buildCost: 750, incomePerTick: 40, pollutionPerTick: 3 },
    { id: "mine-shaft", zone: "mining", label: "Mine Shaft", role: "extractor", buildCost: 300, incomePerTick: 6, pollutionPerTick: 1, payout: { Rich: 800, Trace: 300, other: 100 } },
    { id: "open-pit-mine", zone: "mining", label: "Open Pit Mine", role: "extractor", buildCost: 500, incomePerTick: 8, pollutionPerTick: 2, payout: { Rich: 1200, Trace: 500, other: 150 } },
  ];
